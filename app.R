                  ...
                  sidebarPanel(width = 3,
                               ...
                               column(12,
                                      splitLayout(cellWidths = c("40%","40%"),
                                                  actionButton("start","Start!",style="background-color: #85c8f0; border-color: #85c8f0; border-radius: 12px"), 
                                                  actionButton("reset","Reset",style="background-color: #85c8f0; border-color: #85c8f0; border-radius: 12px"),
                                                  align = "center",
...
server <- function(input, output, session) {
  ...
  observeEvent(input$start, {
    ...
    data <- tibble(name,mail,initials,score, permission_mail, permission, time) %>%
